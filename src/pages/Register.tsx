      ...
      <div className="mx-auto grid w-full max-w-6xl grid-cols-1 gap-6 px-6 py-12 lg:grid-cols-2 lg:py-20">
        <div className="hidden lg:flex lg:flex-col lg:justify-center">
          ...
          <div className="mt-3 max-w-md text-sm text-zinc-400">
            Crea tu cuenta para empezar a registrar movimientos.
          </div>
        </div>
              ...
              <form onSubmit={onSubmit} className="space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  {fieldErrors.password ? (
                    ...
                    <div className="text-xs text-zinc-500">Guarda este acceso; no hay recuperación en el MVP.</div>
                  )}
                </div>
                ...
                <div className="flex items-center justify-between text-sm">
                  <div className="text-zinc-400">¿Ya tienes cuenta?</div>
